...
<main>
  ...
  <p class="meta">
    ...
    <strong>В сила от:</strong> <em>07.03.2026</em> &nbsp;|&nbsp;
    <strong>Последна актуализация:</strong> <em>07.03.2026</em>
  </p>

  <div class="box">
    <p><strong>ДАННИ ЗА ОПЕРАТОРА / АДМИНИСТРАТОРА</strong></p>
    <ul>
      <li><strong>Търговско наименование:</strong> <em>Коде ИД</em></li>
      <li><strong>Правноорганизационна форма:</strong> <em>ООД</em></li>
      <li><strong>ЕИК:</strong> <em>208716833</em></li>
      <li><strong>Седалище и адрес на управление:</strong> <em>гр. София, п.к. 1505
      р-н Подуяне
      ж.к. ж.к. Сухата река, бул./ул. ул. "Вършец" № 16 </em></li>
      <li><strong>Имейл за контакт:</strong> <em>support@kar.bg</em></li>
    </ul>
    <p class="small">
  ...
  <p>8.4. При установена явна техническа грешка при начисляване/таксуване, Потребителят следва да уведоми Kar.bg на <em>support@kar.bg</em> без неоправдано забавяне.</p>
  ...
  <p>Администратор на лични данни: <strong>Коде ИД ООД</strong>, ЕИК <strong>208716833</strong>, адрес <strong>гр. София, п.к. 1505
р-н Подуяне
ж.к. ж.к. Сухата река, бул./ул. ул. "Вършец" № 16 </strong>.<br />Контакт: <strong>support@kar.bg</strong> &nbsp</p>
  ...
  <p>Изпратете искане на <strong>support@kar.bg</strong> с достатъчно информация за идентификация. Kar.bg може да изиска допълнителни данни за потвърждение на самоличността, когато това е необходимо за сигурност.</p>
  ...
  <div class="box">
    ...
    <p>За въпроси относно тези условия, личните данни или бисквитките, пишете на: <strong>support@kar.bg</strong></p>
  </div>
</main>
`;
